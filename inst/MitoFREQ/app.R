    ...
    sidebarLayout(
        sidebarPanel(
          textInput(inputId = "selected_variants", 
                    ...
                    value = ""),
          p("Note: Entire mitogenome (1-16,569), parts not supported."),
          ...
          p("Note: TLHG frequency is based on distribution from Helix."),
          ...
          tags$ul(
            ...
            tags$li("TLHG frequency is based on distribution from Helix."),
